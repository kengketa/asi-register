<template>
    <Layout>
        ...
        <div class="w-full flex justify-center py-2 lg:py-8">
            <div
                class="bg-white rounded-xl shadow-lg  py-10 px-4 lg:px-20 space-y-1  lg:space-y-4">
                ...
                <div class="text-sm md:text-base space-y-1  lg:space-y-4">
                    ...
                    <div class="grid grid-cols-12 gap-2">
                        ...
                        <div class="col-span-6">
                            <ul>
                                <li v-for="(type,index) in performance.type" :key="index">{{ type }}</li>
                            </ul>
                        </div>
                    </div>
                    <!-- Description -->
